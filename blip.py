...
# --- Quick Fix for Transformers >= 4.50 / BLIP Generation ---
try:
    from transformers.generation import GenerationMixin
    if GenerationMixin not in BertLMHeadModel.__bases__:
        BertLMHeadModel.__bases__ = (GenerationMixin,) + BertLMHeadModel.__bases__
except Exception as e:
    print(f"Error in dynamic GenerationMixin fix: {e}")
# -----------------------------------------------------------
